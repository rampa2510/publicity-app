...
export default class index extends PureComponent{
  ...
  fetchData = async (shouldRefresh)=>{
    ...
    try {
      let data = await this.analysis.getAllData()
      this.dataArr=data
  ...
  renderUserData=()=>{
    ...
    return this.state.data.map(d=><UsernameCard key={d._id} name={d.username} added={d.added} />)
  }
  ...
  render(){
    ...
    if(this.state.isLoading)
      return <SpinnerScreen message="Loading users" />
    ...
    return(
      <View style={styles.mainContainer}>
         ...
         <FlatList
          ...
          renderItem={({item})=> <UsernameCard name={item.username} added={item.added} />}
